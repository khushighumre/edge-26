    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor={"#A1202A"} />
              <stop offset="25%" stopColor={"#C9A876"} />
              <stop offset="50%" stopColor={"#A1202A"} />
              <stop offset="75%" stopColor={"#C9A876"} />
              <stop offset="100%" stopColor={"#A1202A"} />
            </>
          )}
        </linearGradient>
